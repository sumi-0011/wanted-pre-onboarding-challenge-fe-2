 ...
 * @param {boolean} completed - The complete status of the todo
 ...
 * @param {*} [completed] - The complete status that you want to update
 * @param {*} [category] - The category that you want to update
 * @param {*} [tags] - The tag list that you want to update
 */
function updateTodo(id, content, completed, category, tags) {}
